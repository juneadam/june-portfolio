...
function Blurb(props) {
  return (
    <div className="Blurb blurb-glow m-10 px-5 py-3 z-0 leading-snug object-cover overflow-x-hidden overflow-y-auto flex flex-wrap rounded-2xl bg-transparent border-collapse line border-slate-300/70 hover:border-[#f9706890] text-slate-300 text-xl transition-all duration-1000 ease-in-out">
      <p className="z-10">
