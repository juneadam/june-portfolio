...
function Navbar(props) {
  ...
  return (
    <div
      className={`Navbar z-50 h-screen w-1/6 md:hover:w-1/4 flex flex-col justify-around items-center md:justify-evenly text-center transition-[width] ease-linear duration-500`}
    ...
    >
      ...
      <div className="social-hole flex flex-col md:flex-row md:place-content-evenly ">
        ...
        <a
          href="https://www.github.com/juneadam"
          target="_blank"
          rel="noreferrer"
        >
          <NavIcon
        ...
        <a
          href="https://www.linkedin.com/in/june-balter"
          target="_blank"
          rel="noreferrer"
        >
          <NavIcon
