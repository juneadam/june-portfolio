...
function NavIcon(props) {
  ...
  return (
    <button
      key={props.type}
      className="icon-hole px-1 rounded-2xl mx-auto transition-all hover:ease-in-out duration-450 hover:shadow-hover-glow hover:bg-pink-500/60 focus:shadow-focus-glow focus:bg-cyan-300/70"
